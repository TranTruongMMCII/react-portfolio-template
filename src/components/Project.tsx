    ...
    return (
        <div className="projects-container" id="projects">
            ...
            <div className="projects-grid">
                ...
                <div className="project">
                    <a href="https://github.com/yujisatojr/multi-reg-analysis" target="_blank" rel="noreferrer"></a>
                ...
                <div className="project">
                    <a href="https://github.com/yujisatojr/submeowrine" target="_blank" rel="noreferrer"></a>
